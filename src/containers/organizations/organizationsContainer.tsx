...
import { getOrganizations, getOrganizationsQuery } from '../../actions/organizationsActions';
...
function mapActionToProps(dispatch: any) {
    return {
        actions: bindActionCreators({getOrganizations, getOrganizationsQuery}, dispatch)
    };
}
